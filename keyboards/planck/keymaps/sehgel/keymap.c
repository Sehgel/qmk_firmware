...
[NAVIGATION]=LAYOUT_planck_grid(
	...
	//--------------------------------------------------------------------------------------------------------------------
	XXXXXXX,XXXXXXX,KC_LALT,XXXXXXX,SCAM   ,KC_SPC ,/*------------------*/KC_ENT,KC_LALT,XXXXXXX,XXXXXXX ,XXXXXXX,XXXXXXX
	//--------------------------------------------------------------------------------------------------------------------
),
...
[FUNCTIONS]=LAYOUT_planck_grid(
	...
	//--------------------------------------------------------------------------------------------------------------------
	XXXXXXX,XXXXXXX,KC_LALT,XXXXXXX,XXXXXXX,KC_SPC ,/*------------------*/KC_ENT ,KC_LALT,XXXXXXX,KC_PSCR,XXXXXXX,XXXXXXX
	//--------------------------------------------------------------------------------------------------------------------
),
