...
[QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX,XXXXXXX,KC_LALT,KC_LWIN,MO(GAMEPLAY_NUMPAD),KC_SPC,KC_ENT,MO(NAVIGATION),MO(SYMBOLS),MO(FUNCTIONS),XXXXXXX,XXXXXXX
),
...
XXXXXXX,XXXXXXX,KC_LALT,KC_LWIN,MO(NUMPAD),KC_SPC,KC_ENT,MO(NAVIGATION),MO(SYMBOLS),MO(FUNCTIONS),XXXXXXX,XXXXXXX
...
XXXXXXX,XXXXXXX,XXXXXXX,KC_LALT,SCAM,KC_SPC,KC_ENT,KC_LALT,KC_F21,XXXXXXX,XXXXXXX,XXXXXXX
),
...
XXXXXXX,XXXXXXX,XXXXXXX,KC_ENT,KC_LALT,KC_SPC,KC_ENT,KC_LSFT,MO(NUMPAD2),XXXXXXX,XXXXXXX,XXXXXXX
),
...
[FUNCTIONS]=LAYOUT_planck_grid(
  ...
  XXXXXXX,XXXXXXX,KC_LALT,XXXXXXX,XXXXXXX, KC_SPC, KC_ENT,KC_LALT,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX
),
