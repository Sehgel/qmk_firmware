...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
                    //QWERTY LAYOUT
                    [QWERTY] = LAYOUT_split_3x6_4(
                    //,-----------------------------------------------------.                    ,-----------------------------------------------------.
                         KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_BSPC,
                    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
                        KC_LCTL,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_RCTL,
                    //|--------+--------+--------+--------+--------+--------|       QWERTY       |--------+--------+--------+--------+--------+--------|
                        KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_M,    KC_N, KC_COMM,  KC_DOT,KC_QUOTE, KC_RSFT,
                    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
                                                 XXXXXXX,KC_LALT, MO(GAMEPLAY_NUMPAD), KC_SPC,    KC_ENT, MO(NAVIGATION), MO(SYMBOLS),MO(FUNCTIONS)
                                                        //`--------------------------'  `--------------------------'
                    ),
               ...
               KC_LSFT, X(L_EXCLAMATION),X(L_QUESTION),KC_QUES,KC_EXLM, ENIE,                       KC_GRV,KC_COLON, KC_LCBR, KC_RCBR,KC_MINUS, KC_RSFT,
                    ...
                    [FUNCTIONS] = LAYOUT_split_3x6_4(
                    //--------------------------------------------------------------------------------------------------------------------
                    KC_F15 ,KC_F12 ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F18 ,/*------------------*/KC_F19 ,KC_F20 ,KC_F21 ,KC_F22 ,KC_F23 ,KC_F24 ,
                    //--------------------------------------------------------------------------------------------------------------------
                    KC_F14 ,KC_F11 ,KC_F4  ,KC_F5  ,KC_F6  ,KC_F17 ,/*------------------*/XXXXXXX,KC_VOLD,KC_MPLY,KC_VOLU,XXXXXXX,XXXXXXX,
                    //--------------------------------------------------------------------------------------------------------------------
                    KC_F13 ,KC_F10 ,KC_F1  ,KC_F2  ,KC_F3  ,KC_F16 ,/*------------------*/XXXXXXX,KC_MPRV,KC_MUTE,KC_MNXT,XXXXXXX,KC_APP ,
                    //--------------------------------------------------------------------------------------------------------------------
