...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
			...
			KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT,KC_QUOTE, KC_RSFT,
               ...
               KC_LSFT, X(L_EXCLAMATION),X(L_QUESTION),KC_QUES,KC_EXLM, ENIE,                       KC_GRV,KC_COLON, KC_LCBR, KC_RCBR,KC_MINUS, KC_RSFT,
                    ...
                    //--------------------------------------------------------------------------------------------------------------------
                    KC_F18 ,KC_F15 ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F12 ,/*------------------*/KC_F19 ,KC_F20 ,KC_F21 ,KC_F22 ,KC_F23 ,KC_F24 ,
                    //--------------------------------------------------------------------------------------------------------------------
                    KC_F17 ,KC_F14 ,KC_F4  ,KC_F5  ,KC_F6  ,KC_F11 ,/*------------------*/XXXXXXX,KC_VOLD,KC_MPLY,KC_VOLU,XXXXXXX,XXXXXXX,
                    //--------------------------------------------------------------------------------------------------------------------
                    KC_F16 ,KC_F13 ,KC_F1  ,KC_F2  ,KC_F3  ,KC_F10 ,/*------------------*/XXXXXXX,KC_MPRV,KC_MUTE,KC_MNXT,XXXXXXX,KC_APP ,
                    //--------------------------------------------------------------------------------------------------------------------
